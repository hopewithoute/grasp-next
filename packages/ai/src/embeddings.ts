...
function resolveEmbeddingEndpoint(env: NodeJS.ProcessEnv) {
  ...
  throw new Error('OPENAI_API_KEY or OPENAI_COMPATIBLE_BASE_URL+OPENAI_COMPATIBLE_API_KEY is required.');
}
...
function resolveEmbeddingApiKey(env: NodeJS.ProcessEnv) {
  ...
  throw new Error('OPENAI_API_KEY or OPENAI_COMPATIBLE_API_KEY is required.');
}
