...
const getCameraOptions = (
  ...
  const target = turf.along(targetRoute, distanceAlong(targetRouteDistance, progress)).geometry
    .coordinates;
  const camera = turf.along(cameraRoute, distanceAlong(cameraRouteDistance, progress)).geometry
    .coordinates;
